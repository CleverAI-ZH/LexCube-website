...
export default function Home() {
  ...
  return (
    <>
      ...
      <main className="font-sans text-gray-900 bg-gradient-to-b from-white to-blue-50 min-h-screen text-center">
      <section className="min-h-screen flex flex-col items-center justify-center text-center px-4">
        <Image src="/logo-lexcube.webp" alt="LexCube Logo" width={180} height={180} className="mb-6" />
